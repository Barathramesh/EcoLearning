    ...
    <div className="eco-runner-game">
      <style>{`
        .eco-runner-game {
          ...
          background: linear-gradient(180deg, #e0f7fa 0%, #e8f5e9 50%, #f1f8e9 100%);
          color: #064e3b;
        ...
        .eco-runner-wrapper .nav-pill.alt {
          background: #ecfdf5;
          color: #047857;
          border-color: rgba(34, 197, 94, 0.4);
        }

        .eco-runner-wrapper .nav-pill span {
          font-size: 0.95rem;
        }

        /* HEADER */

        .eco-runner-wrapper .header {
          text-align: center;
          margin-bottom: 20px;
          margin-top: 12px;
          position: relative;
        ...
        .eco-runner-wrapper .header h1 {
          font-size: 2.6rem;
          letter-spacing: 0.08em;
          text-transform: uppercase;
          background: linear-gradient(90deg, #047857, #0ea5e9, #16a34a);
          -webkit-background-clip: text;
          background-clip: text;
          color: transparent;
        }

        .eco-runner-wrapper .header p {
          margin-top: 8px;
          font-size: 1rem;
          color: #0369a1;
        }
        ...
        .level-btn:hover {
          ...
          box-shadow: 0 14px 26px rgba(148, 163, 184, 0.55);
        }
        ...
        .carbon-bar-wrapper {
          ...
          padding: 4px;
          border: 1px solid rgba(209, 213, 219, 0.9);
          box-shadow: inset 0 0 6px rgba(148, 163, 184, 0.6);
          overflow: hidden;
          position: relative;
        }
        ...
        .carbon-bar-glow {
          position: absolute;
          inset: -10px;
          background: radial-gradient(circle at 0 50%, rgba(34, 197, 94, 0.18), transparent 60%);
          pointer-events: none;
          opacity: 0.8;
        }
        ...
        .game-area {
          ...
          border-radius: 20px;
          overflow: hidden;
          background: linear-gradient(180deg, #dbeafe 0%, #e0f2fe 35%, #dcfce7 65%, #22c55e 100%);
        }
        ...
        .bg-hills {
          ...
          inset: 0;
          background:
            radial-gradient(ellipse at 10% 120%, rgba(22, 163, 74, 0.35) 0 45%, transparent 45%),
            radial-gradient(ellipse at 50% 120%, rgba(34, 197, 94, 0.45) 0 48%, transparent 48%),
            radial-gradient(ellipse at 90% 120%, rgba(21, 128, 61, 0.35) 0 44%, transparent 44%);
        ...
        .game-over-card {
          ...
          max-width: 360px;
          text-align: center;
          box-shadow: 0 18px 35px rgba(148, 163, 184, 0.6);
          color: #0f172a;
          position: relative;
          overflow: hidden;
        }

...
function WaterSolutionsPanel({ pollutionLevel }) {
  const [isExpanded, setIsExpanded] = useState(true);
  
  const solutions = [
    { icon: "🚰", title: "Use Water Filters", desc: "Install filters to remove contaminants", impact: "99% bacteria removed" },
    { icon: "🏭", title: "Industrial Treatment", desc: "Proper wastewater treatment plants", impact: "Removes 95% toxins" },
    { icon: "🌿", title: "Wetland Restoration", desc: "Natural water purification systems", impact: "Filters 5M gal/day" },
    { icon: "🚮", title: "Proper Disposal", desc: "Never dump chemicals in drains", impact: "Prevents 40% pollution" },
    { icon: "🧪", title: "Regular Testing", desc: "Monitor water quality frequently", impact: "Early detection" },
    { icon: "🌱", title: "Reduce Fertilizers", desc: "Use organic farming methods", impact: "50% less runoff" },
  ];
  ...
  return (
    <Html position={[-3.5, 0.5, 0]} center>
      <div className="transition-all duration-500" style={{ width: '260px' }}>
        {/* Header */}
        <div 
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-cyan-100 text-xs">Take action now!</p>
            </div>
          </div>
        ...
        {isExpanded && (
          <div className="bg-slate-900/95 backdrop-blur-sm border border-cyan-500/30 rounded-b-xl p-3 space-y-2 shadow-xl max-h-[350px] overflow-y-auto">
            ...
            <div className="bg-red-500/20 border border-red-500/50 rounded-lg p-2 mb-3 animate-pulse">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-red-300 text-xs">Water quality severely compromised!</p>
                </div>
              </div>
            </div>
            ...
            {solutions.slice(0, visibleSolutions).map((solution, index) => (
              <div 
                key={index}
                className="bg-slate-800/80 rounded-lg p-2 border border-slate-700 hover:border-cyan-500/50 transition-all duration-300 hover:bg-slate-700/80 cursor-pointer group"
              >
                <div className="flex items-start gap-2">
                  <span className="text-xl group-hover:scale-110 transition-transform duration-300">{solution.icon}</span>
                  <div className="flex-1">
                    <h4 className="text-cyan-400 font-semibold text-xs">{solution.title}</h4>
            ...
            <div className="mt-3 pt-2 border-t border-slate-700">
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs text-slate-400">Solutions unlocked</span>
                <span className="text-xs text-cyan-400">{visibleSolutions}/{solutions.length}</span>
              </div>
              <div className="w-full bg-slate-700 rounded-full h-1.5">
                <div 
                  className="bg-gradient-to-r from-cyan-500 to-blue-400 h-1.5 rounded-full transition-all duration-500"
                  style={{ width: `${(visibleSolutions / solutions.length) * 100}%` }}
                />
              </div>
            </div>
            ...
            {/* CTA */}
            <button className="w-full mt-2 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-bold py-2 px-4 rounded-lg text-xs transition-all duration-300 shadow-lg">
...
function SolutionsPanel({ plasticLevel }) {
  const [isExpanded, setIsExpanded] = useState(true);
  
  const solutions = [
    { icon: "🛍️", title: "Use Cloth Bags", desc: "Replace plastic bags with reusable cloth bags", impact: "Saves 170 bags/year" },
    { icon: "🍶", title: "Refillable Bottles", desc: "Use glass or metal water bottles", impact: "Saves 156 bottles/year" },
    { icon: "🥡", title: "Avoid Takeout Plastic", desc: "Bring your own containers for food", impact: "Reduces 40% waste" },
    { icon: "🌱", title: "Composting", desc: "Compost organic waste to enrich soil", impact: "30% less landfill" },
    { icon: "♻️", title: "Proper Recycling", desc: "Separate and recycle plastics correctly", impact: "75% can be recycled" },
    { icon: "🚫", title: "Say No to Straws", desc: "Use paper or metal straws instead", impact: "500M straws/day saved" },
  ];
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-green-100 text-xs">Take action now!</p>
            </div>
          </div>
          <span className={`text-white transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`}>
            ▼
        ...
        {isExpanded && (
          <div className="bg-slate-900/95 backdrop-blur-sm border border-green-500/30 rounded-b-xl p-3 space-y-2 shadow-xl max-h-[350px] overflow-y-auto">
            ...
            <div className="bg-red-500/20 border border-red-500/50 rounded-lg p-2 mb-3 animate-pulse">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-red-300 text-xs">Immediate action needed!</p>
                </div>
              </div>
            </div>
            ...
            {solutions.slice(0, visibleSolutions).map((solution, index) => (
              <div 
                key={index}
                className="bg-slate-800/80 rounded-lg p-2 border border-slate-700 hover:border-green-500/50 transition-all duration-300 hover:bg-slate-700/80 cursor-pointer group"
              >
                <div className="flex items-start gap-2">
                  <span className="text-xl group-hover:scale-110 transition-transform duration-300">{solution.icon}</span>
                  <div className="flex-1">
                    <h4 className="text-green-400 font-semibold text-xs">{solution.title}</h4>
                    <p className="text-slate-400 text-xs leading-tight">{solution.desc}</p>
            ...
            <div className="mt-3 pt-2 border-t border-slate-700">
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs text-slate-400">Tips unlocked</span>
                <span className="text-xs text-green-400">{visibleSolutions}/{solutions.length}</span>
              </div>
              <div className="w-full bg-slate-700 rounded-full h-1.5">
                <div 
            ...
            {/* CTA */}
            <button className="w-full mt-2 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-bold py-2 px-4 rounded-lg text-xs transition-all duration-300 shadow-lg">
...
function EnhancedSoilCrossSection({ plasticLevel }) {
  ...
  return (
    <group position={[0, -0.5, 0]}>
      ...
      {plasticLevel >= 60 && <SolutionsPanel plasticLevel={plasticLevel} />}
    </group>
  );
}
...
function AirSolutionsPanel({ smokeLevel }) {
  const [isExpanded, setIsExpanded] = useState(true);
  
  const solutions = [
    { icon: "🚲", title: "Use Bicycles", desc: "Bike or walk for short distances", impact: "Zero emissions" },
    { icon: "🚌", title: "Public Transport", desc: "Use buses and trains instead of cars", impact: "70% less CO₂" },
    { icon: "🌳", title: "Plant Trees", desc: "Trees absorb CO₂ and release oxygen", impact: "1 tree = 22kg CO₂/yr" },
    { icon: "⚡", title: "Electric Vehicles", desc: "Switch to EVs for cleaner transport", impact: "50% less emissions" },
    { icon: "🏠", title: "Clean Energy", desc: "Use solar and wind power at home", impact: "100% renewable" },
    { icon: "🏭", title: "Industrial Filters", desc: "Install scrubbers in factories", impact: "90% particles removed" },
  ];
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-amber-100 text-xs">Breathe easier!</p>
            </div>
          </div>
          <span className={`text-white transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`}>
            ▼
        ...
        {isExpanded && (
          <div className="bg-slate-900/95 backdrop-blur-sm border border-amber-500/30 rounded-b-xl p-3 space-y-2 shadow-xl max-h-[350px] overflow-y-auto">
            ...
            <div className="bg-red-500/20 border border-red-500/50 rounded-lg p-2 mb-3 animate-pulse">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-red-300 text-xs">Unhealthy for sensitive groups!</p>
                </div>
              </div>
            </div>
            ...
            {solutions.slice(0, visibleSolutions).map((solution, index) => (
              <div 
                key={index}
                className="bg-slate-800/80 rounded-lg p-2 border border-slate-700 hover:border-amber-500/50 transition-all duration-300 hover:bg-slate-700/80 cursor-pointer group"
              >
                <div className="flex items-start gap-2">
                  <span className="text-xl group-hover:scale-110 transition-transform duration-300">{solution.icon}</span>
                  <div className="flex-1">
                    <h4 className="text-amber-400 font-semibold text-xs">{solution.title}</h4>
                    <p className="text-slate-400 text-xs leading-tight">{solution.desc}</p>
            ...
            <div className="mt-3 pt-2 border-t border-slate-700">
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs text-slate-400">Solutions unlocked</span>
                <span className="text-xs text-amber-400">{visibleSolutions}/{solutions.length}</span>
              </div>
              <div className="w-full bg-slate-700 rounded-full h-1.5">
                <div 
            ...
            {/* CTA */}
            <button className="w-full mt-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold py-2 px-4 rounded-lg text-xs transition-all duration-300 shadow-lg">
              🌳 Plant a Tree Today!
            </button>
          </div>
        )}
...
function WaterLabScene({ pollutionLevel }) {
  ...
  return (
    <>
      ...
      {/* Solutions Panel - Appears when pollution exceeds 60% */}
      {pollutionLevel >= 60 && <WaterSolutionsPanel pollutionLevel={pollutionLevel} />}
...
function SoilLabScene({ plasticLevel }) {
  return (
    <>
      ...
      <EnhancedSoilCrossSection plasticLevel={plasticLevel} />
...
function AirLabScene({ smokeLevel, trafficLevel, treeCount }) {
  return (
    <>
      ...
      {/* Solutions Panel - Appears when pollution exceeds 60% */}
      {smokeLevel >= 60 && <AirSolutionsPanel smokeLevel={smokeLevel} />}
...
const EcoLab = () => {
  ...
  const [activeLab, setActiveLab] = useState(null); // 'water', 'soil', 'air', or null
    ...
    return (
      <div className="fixed inset-0 z-50 bg-slate-900">
        ...
        <div className="absolute top-4 left-4 z-50 flex items-center gap-3 bg-slate-800/80 backdrop-blur-sm px-4 py-2 rounded-xl border border-slate-600">
          ...
          <span className="text-white font-bold text-lg capitalize">{activeLab} Lab</span>
          <Badge className={activeLab === 'water' ? waterStatus.color : activeLab === 'soil' ? soilStatus.color : airStatus.color}>
            {activeLab === 'water' ? waterStatus.label : activeLab === 'soil' ? soilStatus.label : airStatus.label}
          </Badge>
        </div>
        ...
        <div className="w-full h-full">
          <Canvas shadows camera={{ 
            position: activeLab === 'water' ? [0, 0, 6] : activeLab === 'soil' ? [0, 1, 5] : [0, 2, 12], 
            fov: activeLab === 'air' ? 55 : 45 
          }}>
            {activeLab === 'water' && <WaterLabScene pollutionLevel={pollutionLevel} />}
            {activeLab === 'soil' && <SoilLabScene plasticLevel={plasticLevel} />}
            {activeLab === 'air' && (
              <AirLabScene 

...
Use simple student-friendly language.`
  ...
  const handleSendMessage = async () => {
    if (chatInput.trim() || selectedImage) {
      const messageText = chatInput || (selectedImage ? "🖼️ Analyze this image" : "");
              ...
              {isLoadingHistory ? (
                ...
                <>
                  {chatHistory.map((message, index) => (
                    ...
                    >
                      {message.type === 'ai' && (
                        <div className="w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center mr-2 flex-shrink-0">
                      ...
                      <div className={`max-w-[80%] ${
                        message.type === 'user' 
                          ? 'bg-green-500 text-white rounded-2xl rounded-br-sm px-4 py-3' 
                        ...
                        {message.type === 'ai' ? (
                          <div className="text-sm">{formatAIMessage(message.message)}</div>
                        ) : (
                      ...
                      {message.type === 'user' && (
                        <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center ml-2 flex-shrink-0">

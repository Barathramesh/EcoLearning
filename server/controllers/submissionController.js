  ...
  try {
    ...
    if (assignment.enableAIGrading !== false && content && content.trim().length > 10) {
      try {
        ...
        if (aiGradingResult.success) {
          ...
          submission.feedback = aiGradingResult.aiGrading.studentFeedback;
          submission.gradedAt = new Date();
          submission.gradedBy = 'AI Auto-Grader';
          submission.aiGrading = aiGradingResult.aiGrading;
    ...
    res.status(201).json({ 
      ...
      aiGrading: aiGradingResult ? {
        ...
        feedback: aiGradingResult.aiGrading?.studentFeedback,
